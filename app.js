// array of different player card objects i.e. names and images of the pairs of cards used in the game user interface
let cardsArray = [
  {
    name: "player1",
    pic: "./pics/pic1.jpeg",
...
//the function is called when the webpage is loaded and when the game is restarted by the user by clicking the restart button
